...
$(BUILD_DIR)/install.o: $(SRC_DIR)/install.c $(SRC_DIR)/install.h $(SRC_DIR)/download.h $(SRC_DIR)/archive.h $(SRC_DIR)/skill.h $(SRC_DIR)/agent.h $(SRC_DIR)/lockfile.h $(SRC_DIR)/resolve.h $(SRC_DIR)/util.h
